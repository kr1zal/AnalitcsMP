...
export const PRICING_FEATURES: PricingFeature[] = [
  ...
  { name: 'Маркетплейсы', free: 'WB + Ozon', pro: 'WB + Ozon' },
  { name: 'Макс. SKU', free: '15', pro: '50' },
  { name: 'Авто-синхронизация', free: '2 раза/день', pro: 'каждые 6ч' },
  { name: 'Ручное обновление', free: '1/день', pro: '3/день' },
  { name: 'Удержания (детализация)', free: true, pro: true },
  { name: 'Сравнение периодов', free: true, pro: true },
  { name: 'Telegram', free: 'Сводка 1\u00D7/день', pro: 'Полный (алерты, AI)' },
  { name: 'Unit-экономика', free: false, pro: true },
  { name: 'Реклама и ДРР', free: false, pro: true },
  { name: 'План продаж', free: false, pro: true },
...
export const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      'Free-тариф работает без ограничений по времени. Он включает дашборд с ключевыми метриками, оба маркетплейса (WB + Ozon), до 15 SKU, полную детализацию удержаний, сравнение периодов, Telegram-сводку 1 раз в день и 1 ручную синхронизацию. Этого достаточно для полноценной работы.',
  },
  {
    question: 'Чем Pro отличается от бесплатного?',
    answer:
      'Pro (1 490 \u20BD/мес) расширяет лимиты до 50 SKU и 3 ручных синхронизаций в день. Добавляет unit-экономику с разбивкой FBO/FBS, рекламную аналитику с ДРР, план продаж с прогнозом, PDF экспорт и полный Telegram с алертами и AI-поддержкой.',
  },
  {
    question: 'Как часто обновляются данные?',
    answer:
      'Данные синхронизируются автоматически. На Free-тарифе - 2 раза в день + 1 ручная синхронизация, на Pro - каждые 6 часов + 3 ручных в день. Утром вы уже видите вчерашние цифры.',
  },
  {
