...
> **Используется в:** `backend/app/services/sync_service.py` (sync_costs_ozon)
> **Ключевые поля:** posting.delivery_schema, operation_type, accruals_for_sale, sale_commission, amount, services[], items[].sku
