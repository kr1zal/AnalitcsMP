# FBS Необработанные отправления
> **Endpoint:** `POST /v3/posting/fbs/unfulfilled/list`
> **Источник:** docs.ozon.ru (скопировано 26.02.2026)
> **Используется в:** `backend/app/services/sync_service.py` (sync_orders_ozon)
> **Ключевые поля:** posting_number, status, products[].sku, products[].price, products[].quantity, created_at
