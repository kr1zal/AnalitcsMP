# ФАЙЛ 2: FBO Постинги — /v2/posting/fbo/list

> СЮДА скопируй страницу: https://docs.ozon.ru/api/seller/#operation/PostingAPI_GetFboPostingListV2
> Или найди в левом меню: FBO → Получить список отправлений (Get FBO posting list)
> Нужно: Request Body schema + Response schema (200) + все вложенные объекты
