...
> **Используется в:** `backend/app/services/sync_service.py` (sync_sales_ozon)
> **Ключевые поля:** metrics[revenue, ordered_units], dimensions[sku, day], date_from, date_to
...
Список метрик, по которым будет сформирован отчёт.
