# ФАЙЛ 6: Информация об отчёте (статус + ссылка на скачивание) — /v1/report/info

> Источник: docs.ozon.ru (нужно скопировать вручную)
> Дата: 2026-02-28
> Зачем нам: поллинг статуса отчёта по storage costs и получение URL для скачивания CSV
