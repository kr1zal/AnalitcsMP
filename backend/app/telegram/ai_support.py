...
ТАРИФЫ:
- Free: бесплатно, до 15 SKU, WB + Ozon, синхронизация 2 раза/день + 1 ручная, полная детализация удержаний, сравнение периодов, Telegram-сводка 1 раз/день, AI-поддержка
- Pro: 1 490 руб/мес (990 руб при годовой), до 50 SKU, WB + Ozon, FBO/FBS-аналитика, синхронизация каждые 6 часов + 3 ручных/день, unit-экономика, реклама и ДРР, план продаж, PDF экспорт, полный Telegram с алертами
