...
-- =============================================
-- 1. get_dashboard_summary: агрегация sales/costs/ads одним запросом
-- =============================================
...
-- =============================================
-- 2. get_costs_tree: иерархия удержаний (как в ЛК Ozon/WB)
-- =============================================
...
-- =============================================
-- 3. get_costs_tree_combined: объединяет ozon и wb в 1 запрос
...
-- =============================================
-- 4. get_dashboard_summary_with_prev: summary + prev period в 1 запрос
...
-- =============================================
COMMENT ON FUNCTION get_dashboard_summary IS 'Агрегация sales/costs/ads одним запросом. Возвращает summary с метриками.';
COMMENT ON FUNCTION get_costs_tree IS 'Иерархия удержаний (как в ЛК Ozon/WB). Поддерживает детализацию из mp_costs_details или fallback на mp_costs.';
